    ...
    <div class="col-lg-2 col-md-3 col-sm-4">
        <div class="bs-sidebar">
            <ul id="ul_eqLogic" class="nav nav-list bs-sidenav">
                <a class="btn btn-default eqLogicAction" style="width : 100%;margin-top : 5px;margin-bottom: 5px;" data-action="add"><i class="fas fa-plus-circle"></i> {{Ajouter un ELM Touch}}</a>
...
try {
	...
	if (is_object($plugin)) {
?>
    <li  role="presentation"><a href="#configureSchedule" aria-controls="profile" data-toggle="tab"><i class="fas fa-clock-o"></i> {{Programmation}}</a></li>
<?php
}
} catch (Exception $e) {
