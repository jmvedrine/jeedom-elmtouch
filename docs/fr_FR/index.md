...
ATTENTION ! Ce plugin n'est pas compatible avec les modèles CT100.2 ou CT200 (appelés Easy Control) mais seulement avec le modèle CT100 qui est plus ancien.

Voici une image des différents modèles : de gauche à droite CT100 (alias nefit easy, alias elm touch) CT200 blanc (alias easy control alias CT100.2) et CT200 noir.

![elmtouch01](../images/thermostats.png)
...
| **Nom du mode**                      | info    | string     | Nom du mode actif (Activer programme ou Désactiver programme)                                                                                                      |
| **Mode**                             | info    | binary     | Vaut 1 si la chaudière est en mode programme et 0 si elle est en mode manuel. Associée aux deux commandes action **Activer programme** et **Désactiver programme**.|
| **Désactiver programme**             | action  | other      | Fait passer le thermostat en mode manuel (la main)                                                                                                                 |
| **Activer programme**                | action  | other      | Fait passer le thermostat en mode programme (l'horloge)                                                                                                            |
